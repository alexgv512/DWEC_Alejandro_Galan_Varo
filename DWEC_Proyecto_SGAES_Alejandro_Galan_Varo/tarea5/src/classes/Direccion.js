...
export class Direccion {
    ...
    constructor(calle, numero, piso, codigoPostal, provincia, localidad) { //Constructor de la clase Direccion
        ...
        if (!codigoPostal || codigoPostal.length != 5 || !/[0-9]/.test(codigoPostal)) {
    ...
    static fromJSON(json) {
        return new Direccion(json.calle, json.numero, json.piso, json.codigoPostal, json.provincia, json.localidad);
    }
}